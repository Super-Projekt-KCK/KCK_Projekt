    ...
    (
        {
            ...
            3:[function(t,e){function r(t,e,r)
            {
                    ...
                    ,r.prototype.getNeighbors=function(t,e,r)
                {
                    ...
                    this.isWalkableAt(i+1,n+1)&&o.push(d[n+1][i+1]),f&&
