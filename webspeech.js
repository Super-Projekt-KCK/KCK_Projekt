...
var status_array_en = {
  'ready' : 'Kliknij w ikonę mikrofonu',
  'active' : 'Możesz mówić.',
  'no-speech' : 'Nie wykryto mowy. Popraw swój ' +
  ...
  'allow' : 'Wciśnij `Zezwól` na górze.',
  'not-allowed' : 'Odrzucono poznolenie na użycie mikrofonu. Aby to zmienić idź do ' +
      'chrome://settings/contentExceptions#media-stream',
  'upgrade' : 'Web Speech API nie jest wspierane przez tą przeglądarkę.  Zmień na ' +
